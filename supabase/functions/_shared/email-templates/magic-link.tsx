...
export const MagicLinkEmail = ({ siteName, confirmationUrl }: MagicLinkEmailProps) => (
  <Html lang="es" dir="ltr">
    <Head />
    <Preview>Tu enlace de acceso al Talonario Digital Lacer</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Section style={bodyS}>
          ...
          <Text style={text}>
            Aquí tienes tu enlace seguro para acceder a tu cuenta sin contraseña.
          ...
          <Text style={textSmall}>
            Este enlace caduca en breve. Si no lo has solicitado, puedes ignorar este mensaje.
          </Text>
        </Section>
