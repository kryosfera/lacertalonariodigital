...
export const InviteEmail = ({ siteName, confirmationUrl }: InviteEmailProps) => (
  <Html lang="es" dir="ltr">
    <Head />
    <Preview>Te han invitado al Talonario Digital Lacer</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Section style={bodyS}>
          ...
          <Text style={text}>
            Te han invitado a unirte al <strong>Talonario Digital Lacer</strong>,
            la plataforma para crear y enviar recetas digitales de productos Lacer
            a tus pacientes. Acepta tu invitación para empezar:
          </Text>
