    ...
    <>
      ...
      <div className="fixed inset-0 z-0 overflow-hidden pointer-events-none">
        <div
          ...
          style={{
            background: 'linear-gradient(145deg, hsl(0 72% 51% / 0.25) 0%, hsl(0 72% 45% / 0.12) 40%, hsl(var(--background)) 100%)'
          }}
        />
        {/* Animated glow orbs */}
        <motion.div
          ...
          style={{
            background: 'radial-gradient(circle, hsl(0 72% 55%) 0%, transparent 70%)',
            top: '-5%',
            right: '-10%',
          }}
          animate={{
        ...
        <motion.div
          ...
          style={{
            background: 'radial-gradient(circle, hsl(0 72% 50%) 0%, transparent 70%)',
            bottom: '10%',
            left: '-8%',
          }}
          animate={{
        ...
        />
        <motion.div
          className="absolute w-[200px] h-[200px] rounded-full opacity-[0.07]"
          style={{
            background: 'radial-gradient(circle, hsl(0 72% 60%) 0%, transparent 70%)',
            top: '50%',
            left: '60%',
          }}
          animate={{
