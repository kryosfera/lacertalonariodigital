...
const PrivacyPolicy = () => {
  return (
    <div className="min-h-screen bg-background flex flex-col">
      <SEO
        title="Política de privacidad | Talonario Digital Lacer"
        description="Cómo trata Talonario Digital Lacer los datos personales de profesionales y pacientes conforme al RGPD y la LOPDGDD."
